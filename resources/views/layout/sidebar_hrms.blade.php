<nav class="sidebar">
  ...
  <div class="sidebar-body">
    <ul class="nav">
      ...
      <li class="nav-item {{ active_class(['/portal/hrms/jobs']) }}">
        <a href="{{ url('/portal/hrms/jobs') }}" class="nav-link">
          <i class="link-icon" data-feather="file-text"></i>
          <span class="link-title">Job Postings</span>
        </a>
      </li>

      <li class="nav-item {{ active_class(['/portal/hrms/job_applications']) }}">
        <a href="{{ url('/portal/hrms/job_applications') }}" class="nav-link">
      ...
      <li class="nav-item {{ active_class(['ui-components/*']) }}">
        ...
        <div class="collapse {{ show_class(['ui-components/*']) }}" id="uiComponents">
          <ul class="nav sub-menu">
            <li class="nav-item">
              <a href="{{ url('/portal/hrms/new_person') }}" class="nav-link {{ active_class(['portal/hrms/new_person']) }}">New Person Data</a>
            </li>
            <li class="nav-item">
              <a href="{{ url('/portal/hrms/new_employee') }}" class="nav-link {{ active_class(['portal/hrms/new_employee']) }}">Employment</a>
            </li>
            <li class="nav-item">
