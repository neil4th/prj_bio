...
<div class="row">
    <div class="col-12 col-xl-12 stretch-card">
        <div class="row flex-grow-1">
            <div class="col-md-3 grid-margin stretch-card"> <!-- Adjusted width to col-md-3 for 4 cards in a row -->
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline">
                            <h6 class="card-title mb-0 pb-2">Position</h6>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <h3 class="mb-2">Job Order Daily</h3>
            ...
            <div class="col-md-3 grid-margin stretch-card"> <!-- Adjusted width to col-md-3 -->
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-baseline">
                            <h6 class="card-title mb-0">Days Employed</h6>
                        </div>
                        <div class="row">
                            <div class="col-12">
                                <h3 class="mb-2">3 Months</h3>
                                <div class="d-flex align-items-baseline">
                                    <p class="text-danger">
                                        <span>12 Days</span>
            ...
            <div class="col-md-3 grid-margin stretch-card"> <!-- Adjusted width to col-md-3 -->
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <h3 class="mb-2">Dragon Slaying</h3>
                                <div class="d-flex align-items-baseline">
                                    <p class="text-success">
                                        <span>5 Dragons</span>
                                        <i data-feather="arrow-up" class="icon-sm mb-1"></i>
...
<div class="row">
    ...
    <div class="col-md-4">
        <div id="card" style="height: 535px; overflow-y: auto;">
            <div class="card-body">
                <div class="scrollable-cards" style="max-height: 520px; overflow-y: auto;">

                    <div class="card mb-2">
                        <div class="card-body d-flex align-items-center">
                            <img src="https://via.placeholder.com/150" class="rounded-circle" style="width: 100px; height: 100px;" alt="Profile Picture">
                            <div class="ms-3">
                                <h5 class="card-title mb-1">John Doe</h5>
                                <p class="card-text text-muted mb-1">Web Developer & Designer</p>
                                <p class="card-text text-muted">Birthday: December 15, 2024</p>
                            </div>
                        </div>
                    </div>
                    <div class="card mb-2">
